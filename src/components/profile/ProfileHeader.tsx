...
type TProfileHeaderWithContentProps = {
  user: User;
  member?: UserGuildProfile;
};

export const ProfileHeaderWithContent: React.FC<
  TProfileHeaderWithContentProps
> = ({ user, member }) => {
  return (
    <div className="mb-4">
...
type TProfileHeaderProps = TProfileHeaderWithContentProps;

const ProfileHeader: React.FC<TProfileHeaderProps> = ({ user }) => {
